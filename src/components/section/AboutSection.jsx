...
const AboutSection = () => {
  return (
    <div className="w-screen min-h-96 flex flex-col items-center justify-start red gap-10">
      <div className="w-full text-2xl  ">
        <h1 className="px-2 font-medium py-5">About us ...</h1>
      </div>
      <div className="w-full h-96 flex items-center justify-center  p-5">
